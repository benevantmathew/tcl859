...
TK_LIBS='-lX11 -lXss -lXext   -ldl  -lm'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/benevantmathew/github/public/tcl859/tk8.5.9/unix -ltk8.5'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/usr/local/lib -ltk8.5'
...
# compiled.
TK_SRC_DIR='/home/benevantmathew/github/public/tcl859/tk8.5.9'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/benevantmathew/github/public/tcl859/tk8.5.9/unix -ltkstub8.5'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/usr/local/lib -ltkstub8.5'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/benevantmathew/github/public/tcl859/tk8.5.9/unix/libtkstub8.5.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/usr/local/lib/libtkstub8.5.a'
